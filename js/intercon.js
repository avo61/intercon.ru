 ...
 ! function() {
     ...
     //  var deltaBaner = 1;
     var i = 1;
     var tvmBaners = document.querySelectorAll('.isp-baner__image');
     var cntBaner = tvmBaners.length;
     var stepBaner = cntBaner - 1;
     var timerId = setInterval(function() {
         tvmBaners.forEach(function(bnr, i, arr) {
             //  alert(i + ": " + bnr + " (массив:" + arr + ")");
             bnr.classList.remove('isp-baner__image--select');
         });
         i = stepBaner;
         tvmBaners[i].classList.add('isp-baner__image--select__1');
         stepBaner = (stepBaner + 1) % cntBaner;
         tvmBaners[stepBaner].classList.add('isp-baner__image--select');
         setTimeout(function() {
             tvmBaners[i].classList.remove('isp-baner__image--select__1');
         }, 2000);
         console.log("stepBaner = ", stepBaner, "i = ", i);
     }, 5000);
